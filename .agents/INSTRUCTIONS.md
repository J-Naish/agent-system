...
| スキル | 概要 | 使うタイミング |
|--------|------|---------------|
| **industry-landscape** | 対象業界の前提知識（概要・専門用語・ビジネスモデル・バリューチェーン・キープレイヤー）を体系的に調査する | 新しい業界を理解したい時、market-researchの前段階として |
...
| **market-research** | 対象事業に関連する法規制・許認可・公的支援を調査する | 法規制調査、許認可確認、補助金・公的支援を調べたい時 |
