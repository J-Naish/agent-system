...
8. 全ステップ完了後、`summary.md`（総括 + 参照ソース一覧）を作成する
...
├── 5-trend-analysis.md        # トレンド分析
└── summary.md                 # 総括 + 参照ソース一覧
```
...
## 各ステップファイル
- [0. 前提知識](0-ground-zero.md)
- [1. 市場調査](1-market-research.md)
- [2. 競合分析](2-competitor-analysis.md)
- [3. 法規制](3-regulatory-research.md)
- [4. 価格調査](4-pricing-research.md)
- [5. トレンド分析](5-trend-analysis.md)
